...
def cellpose_seg(img,
                 model,
                 lower = 0.0,
                 upper = 800.0,
                 cell_diameter = 30.0):

    img = normalize_custom(img, lower = lower, upper = upper)
...
output_zarr_path = f"/path/concat_seg.zarr"
